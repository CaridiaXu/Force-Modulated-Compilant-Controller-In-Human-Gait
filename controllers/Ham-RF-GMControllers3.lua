function init( model, par, side )
    ...
    -- }   -- 586 gen 1.754
    muscle_configs = {
        {name = "rect_fem", L0 = 0.886146, alpha = 1.0, min = 0.85, max = 0.9},
        {name = "hamstrings", L0 = 0.805833, alpha = 1.0, min = 0.6, max = 1.0},
        {name = "glut_med", L0 = 0.747344, alpha = 1.0, min = 0.0, max = 1.0}
    }   -- 
    ...
    for _, config in ipairs(muscle_configs) do
        ...
        --               3.138 -- for glut_med
        --               -- 586 gen 1.754
        local c_mean = muscle_name == "rect_fem" and 0.926955 or
                      muscle_name == "hamstrings" and 1.271189 or 
                      3.198369 -- for glut_med
                      -- 
