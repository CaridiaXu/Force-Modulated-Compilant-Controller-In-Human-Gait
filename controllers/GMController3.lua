function init( model, par, side )
    ...
    muscle_configs = {
        -- {name = "rect_fem", L = 0.8, alpha = 1.0, min = 0.75, max = 1.0},
        -- {name = "add_mag", L = 0.11, alpha = 5.0, std = 0.01, min = 0.0, max = 1.0},
        -- {name = "glut_med", L = 0.75, alpha = 1.0, std = 0.01, min = 0.0, max = 2.0},  -- 491 gen 1.532, state controller is not working
        -- {name = "glut_med", L = 0.7, alpha = 1.0, std = 0.01, min = 0.0, max = 2.0},  -- 339 gen 1.524, 475 gen 1.434, 514 gen 1.373(most stable), state controller is not working
        -- {name = "glut_med", L = 0.7, alpha = 1.0, std = 0.01, min = 0.0, max = 1.0},  -- 279 gen 1.372, state controller working
        -- {name = "glut_med", L = 0.75, alpha = 1.0, std = 0.01, min = 0.0, max = 1.0},  -- 206 gen 1.248, state controller working
        {name = "glut_med", L = 0.72, alpha = 1.0, std = 0.01, min = 0.0, max = 1.0},  -- 206 gen 1.248, state controller working
        -- {name = "hamstrings", L = 0.78, alpha = 1.0, min = 0.6, max = 1.0},   -- 0.78 0.85
        -- {name = "iliopsoas", L = 0.26, alpha = 5.0, std = 0.01, min = 0.0, max = 1.0}
    }
